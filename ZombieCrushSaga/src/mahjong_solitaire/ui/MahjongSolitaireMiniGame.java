...
public class MahjongSolitaireMiniGame extends MiniGame {
	...
	private MahjongSolitairePanel msp;
	...
	public void savePlayerRecord() {
		...
		try {
			...
			String dataPath = props
					.getProperty(MahjongSolitairePropertyType.DATA_PATH);
			String recordPath = dataPath
					+ props.getProperty(MahjongSolitairePropertyType.RECORD_FILE_NAME);
	...
	public void switchToGameScreen() {
		...
		guiButtons.get(BACK_TYPE).setState(VISIBLE_STATE);
		guiButtons.get(BACK_TYPE).setEnabled(true);
		...
		audio.stop(MahjongSolitairePropertyType.SPLASH_SCREEN_SONG_CUE
				.toString());
		audio.play(MahjongSolitairePropertyType.GAMEPLAY_SONG_CUE.toString(),
				true);
	}
	...
	public void switchToSplashScreen() {
		...
		js=new JScrollPane(msp);
		msp.setLayout(new BorderLayout());
        msp.add(js, BorderLayout.CENTER);
	...
	public void updateBoundaries() {
		...
		float totalWidth = ((MahjongSolitaireDataModel) data).getGridColumns()
				* TILE_IMAGE_WIDTH;
		...
		float topOffset = Integer.parseInt(props
				.getProperty(MahjongSolitairePropertyType.GAME_TOP_OFFSET
						.toString()));
		float totalHeight = ((MahjongSolitaireDataModel) data).getGridRows()
				* TILE_IMAGE_HEIGHT;
	...
	public void initAudioContent() {
		try {
			...
			String audioPath = props
					.getProperty(MahjongSolitairePropertyType.AUDIO_PATH);
			...
			// PLAY THE WELCOME SCREEN SONG
			audio.play(MahjongSolitairePropertyType.SPLASH_SCREEN_SONG_CUE
					.toString(), true);
		} catch (UnsupportedAudioFileException | IOException
				| LineUnavailableException | InvalidMidiDataException
				| MidiUnavailableException e) {
			errorHandler
					.processError(MahjongSolitairePropertyType.AUDIO_FILE_ERROR);
		}
	}
	...
	public void initData() {
		...
		int gameWidth = Integer
				.parseInt(props
						.getProperty(MahjongSolitairePropertyType.GAME_WIDTH
								.toString()));
		int gameHeight = Integer.parseInt(props
				.getProperty(MahjongSolitairePropertyType.GAME_HEIGHT
						.toString()));
		data.setGameDimensions(gameWidth, gameHeight);

		// THIS WILL CHANGE WHEN WE LOAD A LEVEL
		boundaryLeft = Integer.parseInt(props
				.getProperty(MahjongSolitairePropertyType.GAME_LEFT_OFFSET
						.toString()));
	...
	public void initGUIControls() {
		...
		String windowIconFile = props
				.getProperty(MahjongSolitairePropertyType.WINDOW_ICON);
		img = loadImage(imgPath + windowIconFile);
		window.setIconImage(img);

		// CONSTRUCT THE PANEL WHERE WE'LL DRAW EVERYTHING
		canvas = new MahjongSolitairePanel(this,
				(MahjongSolitaireDataModel) data);

		// LOAD THE BACKGROUNDS, WHICH ARE GUI DECOR
		currentScreenState = SPLASH_SCREEN_STATE;
		img = loadImage(imgPath
				+ props.getProperty(MahjongSolitairePropertyType.SPLASH_SCREEN_IMAGE_NAME));
		sT = new SpriteType(BACKGROUND_TYPE);
		sT.addState(SPLASH_SCREEN_STATE, img);
		img = loadImage(imgPath
				+ props.getProperty(MahjongSolitairePropertyType.GAME_BACKGROUND_IMAGE_NAME));
		...
		ArrayList<String> levelImageNames = props
				.getPropertyOptionsList(MahjongSolitairePropertyType.LEVEL_IMAGE_OPTIONS);
		ArrayList<String> levelMouseOverImageNames = props
				.getPropertyOptionsList(MahjongSolitairePropertyType.LEVEL_MOUSE_OVER_IMAGE_OPTIONS);
		...
		for (int i = 0; i < levels.size(); i++) {
			...
			img = loadImageWithColorKey(imgPath + levelImageNames.get(i),
					COLOR_KEY);
			sT.addState(VISIBLE_STATE, img);
			img = loadImageWithColorKey(
					imgPath + levelMouseOverImageNames.get(i), COLOR_KEY);
		...
		String newButton = props
				.getProperty(MahjongSolitairePropertyType.NEW_BUTTON_IMAGE_NAME);
		sT = new SpriteType(NEW_GAME_BUTTON_TYPE);
		img = loadImage(imgPath + newButton);
		sT.addState(VISIBLE_STATE, img);
		String newMouseOverButton = props
				.getProperty(MahjongSolitairePropertyType.NEW_BUTTON_MOUSE_OVER_IMAGE_NAME);
		...
		String backButton = props
				.getProperty(MahjongSolitairePropertyType.BACK_BUTTON_IMAGE_NAME);
		sT = new SpriteType(BACK_TYPE);
		img = loadImage(imgPath + backButton);
		sT.addState(VISIBLE_STATE, img);
		String backMouseOverButton = props
				.getProperty(MahjongSolitairePropertyType.BACK_BUTTON_MOUSE_OVER_IMAGE_NAME);
		...
		String undoButton = props
				.getProperty(MahjongSolitairePropertyType.UNDO_BUTTON_IMAGE_NAME);
		sT = new SpriteType(UNDO_TYPE);
		img = loadImage(imgPath + undoButton);
		sT.addState(VISIBLE_STATE, img);
		String undoMouseOverButton = props
				.getProperty(MahjongSolitairePropertyType.UNDO_BUTTON_MOUSE_OVER_IMAGE_NAME);
		...
		String tileCountButton = props
				.getProperty(MahjongSolitairePropertyType.TILE_COUNT_IMAGE_NAME);
		...
		String timeContainer = props
				.getProperty(MahjongSolitairePropertyType.TIME_IMAGE_NAME);
		...
		String statsButton = props
				.getProperty(MahjongSolitairePropertyType.STATS_BUTTON_IMAGE_NAME);
		sT = new SpriteType(STATS_BUTTON_TYPE);
		img = loadImage(imgPath + statsButton);
		sT.addState(VISIBLE_STATE, img);
		String statsMouseOverButton = props
				.getProperty(MahjongSolitairePropertyType.STATS_BUTTON_MOUSE_OVER_IMAGE_NAME);
		...
		String tileStack = props
				.getProperty(MahjongSolitairePropertyType.TILE_STACK_IMAGE_NAME);
		...
		String statsDialog = props
				.getProperty(MahjongSolitairePropertyType.STATS_DIALOG_IMAGE_NAME);
		...
		String winDisplay = props
				.getProperty(MahjongSolitairePropertyType.WIN_DIALOG_IMAGE_NAME);
		...
		String loseDisplay = props
				.getProperty(MahjongSolitairePropertyType.LOSE_DIALOG_IMAGE_NAME);
	...
	public void initGUIHandlers() {
		...
		for (String levelFile : levels) {
			SelectLevelHandler slh = new SelectLevelHandler(this, dataPath
					+ levelFile);
		...
		guiButtons.get(BACK_TYPE).setActionListener(bh);
